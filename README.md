...
These scripts are standardized to accept the exact same inputs generated by ARCADE Stage 1 (sc_counts.csv, sc_labels.csv, st_counts.csv) and output the exact same proportional matrices (proportions.csv), allowing for direct, fair comparisons of speed, accuracy, and robustness.

DestVI
```bash
python benchmarking/run_destvi.py \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
  --output_csv /path/to/output_dir/proportions.csv \
  --output_plot /path/to/output_dir/proportions_heatmap.png \
  --output_corr_plot /path/to/output_dir/validation_correlation.png \
  --n_hvg 12000 \
  --max_epochs_sc 1000 \
  --max_epochs_st 2000 \
  --presence_threshold 0.0 \
...
Starfysh
```bash
python benchmarking/run_Starfysh.py \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
Cell2location
```bash
python benchmarking/run_cell2location.py \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
Stereoscope
```bash
python benchmarking/run_stereoscope.py \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
Tangram
```bash
python benchmarking/run_tangram.py \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
RCTD
```bash
Rscript benchmarking/run_RCTD.R \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
SPOTlight
```bash
Rscript benchmarking/run_SPOTlight.R \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
Seurat (v5)
```bash
Rscript benchmarking/run_seurat.R \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
...
CellTrek
```bash
Rscript benchmarking/run_CellTrek.R \
  --sc_counts /path/to/consistent_cells_subset/sc_counts.csv \
  --sc_labels /path/to/consistent_cells_subset/sc_labels.csv \
  --st_counts /path/to/consistent_cells_subset/st_counts.csv \
  --st_coords /path/to/tissue_positions_list.csv \
